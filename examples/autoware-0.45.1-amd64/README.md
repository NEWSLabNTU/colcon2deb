# Autoware 0.45.1 AMD64 Debian Package Build

This example demonstrates how to build Debian packages for Autoware 0.45.1 on AMD64 architecture.
...
# Clone Autoware 0.45.1 workspace
git clone --branch 0.45.1-ws https://github.com/NEWSLabNTU/autoware.git source
...
git submodule update --init --recursive examples/autoware-0.45.1-amd64/source

# Import dependencies
cd examples/autoware-0.45.1-amd64/source
vcs import src < autoware.repos
```
...
- **Dockerfile**: Local Dockerfile in `../../docker/0.45.1/amd64/`
